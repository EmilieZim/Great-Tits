...
>>>>>>> f314ee4a842c413583ab9fd7c85e5b2074477cfe
...
# to not have to rerun everyithing, I have saved my output here:
...
# SW: I've commented out from here onwards
...
# 
# threshold <- 5
# gbi1.sum <- gbi1[,colSums(gbi1.summ)>=threshold]
# dim(gbi1.sub)
# # that gives 138 rows and 12 columns (=individuals)
# #So 12 individuals that have been seen at least 5 times in the first week. 
# 
